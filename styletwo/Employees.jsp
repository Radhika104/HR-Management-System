...
<a href='/styletwo/EmployeeAddForm.jsp'>Add Employees</a>
</th>
</tr>
<tr>
<th class='employeeGridSNOColumnTitle'>SNo.</th>
...
<div style='height : 19vh; margin-left : 5px; margin-right : 5px; margin-buttom : px;margin-top : 5px;padding : 5px;border : 1px solid black'>
<label style='background:grey; color : white; padding-left : 5px;padding-right : 5px'>Details</label>

<table border='0' width='100%'>
<tr>
<td>Employee Id : <span id='detailPanel_employeeId' style='margin-right :30px'></span></td>
<td>Name : <span id='detailPanel_name' style='margin-right : 70px'></span></td>
<td>Designation : <span id='detailPanel_designation' style='margin-right : 100px'></span></td>
</tr>
<tr>
<td>Date Of birth : <span id='detailPanel_dateOfBirth' style='margin-right : 30px'></span></td>
<td>Gender  : <span id='detailPanel_gender' style='margin-right : 70px'></span></td>
<td>Is Indian : <span id='detailPanel_isIndian' style='margin-right :100px'></span></td>
</tr>
<tr>
<td>Basic Salary : <span id='detailPanel_basicSalary' style='margin-right : 30px'></span></td>
<td>PAN Number : <span id='detailPanel_panNumber' style='margin-right : 70px'></span></td>
<td>Aadhar Card Number : <span id='detailPanel_aadharCardNumber' style='margin-right : 100px'></span></td>
</tr>
</table>
