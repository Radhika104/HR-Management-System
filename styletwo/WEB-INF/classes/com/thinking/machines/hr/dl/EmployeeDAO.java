...
{
int vDesignationCode=employee.getDesignationCode();
...
preparedStatement.close();
connection.close();
throw new DAOException("Pan_number : "+vPanNumber+" already exists.");
}
preparedStatement.close();
resultSet.close();
...
preparedStatement.close();
connection.close();
throw new DAOException("Aadhar_card_number : "+vAadharCardNumber+" already exists.");
}
preparedStatement.close();
resultSet.close();

preparedStatement=connection.prepareStatement("insert into employee(name,designation_code,date_of_birth,gender,is_indian,basic_salary,pan_number,aadhar_card_number) values(?,?,?,?,?,?,?,?)");
...
ResultSet resultSet;
resultSet=statement.executeQuery("select employee.id,employee.name,employee.designation_code,designation.title,employee.date_of_birth,employee.gender,employee.is_indian,employee.basic_salary,employee.pan_number,employee.aadhar_card_number from employee inner join designation where employee.designation_code=designation.code order by employee.name");
